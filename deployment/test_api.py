...
def test_single_prediction() -> bool:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # 🔥 FIXED ONLY KEY NAMES (NO OTHER CHANGE)
            required_keys = [
                "prediction",
                "prediction_label",
                "probability_of_default",
                "probability_of_not_default"
            ]

            result = all(k in data for k in required_keys)
...
def test_batch_prediction() -> bool:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # 🔥 FIXED ONLY KEY NAMES (NO OTHER CHANGE)
            required_keys = ["total_count", "model_version", "predictions"]
