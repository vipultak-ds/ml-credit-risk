    ...
    if binary_proto is not None:
        ...
        if options is None:
            raise IllegalArgumentException(
                ...
                messageParameters={
                    "arg_name": "options",
                    "condition": "calling from_protobuf with schema registry",
                },
            )
        else:
            return _invoke_function(
                "from_protobuf_schema_registry", _to_col(data), _options_to_col(options)
            )
        # END-EDGE
    ...
    # BEGIN-EDGE
        ...
        if options is None:
            raise IllegalArgumentException(
                ...
                messageParameters={
                    "arg_name": "options",
                    "condition": "calling to_protobuf with schema registry",
                },
            )
        else:
            return _invoke_function(
                "to_protobuf_schema_registry", _to_col(data), _options_to_col(options)
            )
    # END-EDGE
