...
class SQLContext:
    ...
    ...            'from allTypes where b and i > 0').collect()  # doctest: +SKIP
    ...
    def getConf(
        ...
        '200'
        >>> sqlContext.getConf("spark.sql.shuffle.partitions", "10")  # doctest: +SKIP
        '10'
        >>> sqlContext.setConf("spark.sql.shuffle.partitions", "50")  # doctest: +SKIP
        >>> sqlContext.getConf("spark.sql.shuffle.partitions", "10")  # doctest: +SKIP
        '50'
        """
